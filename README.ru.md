...
| MobileSAM энкодер + декодер | 27 + 16 МБ | Apache-2.0 | Опциональный движок «SAM» для режимов выделения «Умное»/«Прилипание» |
...
Пара MobileSAM ([ChaoningZhang/MobileSAM](https://github.com/ChaoningZhang/MobileSAM),
Apache-2.0) — не модель удаления фона: она обслуживает движок выделения «SAM» по
промпту (тап по объекту или грубая рамка на экране выбора объектов) и скачивается
при первом использовании этого движка.
