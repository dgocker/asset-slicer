...
const RU = {
  ...
  'selector.engineLabel': 'Движок:',
  'selector.engine.color': 'По цвету',
  'selector.engine.sam': 'SAM',
  'selector.hint.smartSam': 'Коснитесь объекта — нейросеть SAM выделит его точно по контуру. Повторное касание снимает выделение.',
  'selector.hint.snapSam': 'Нарисуйте грубую рамку вокруг объекта — нейросеть SAM вырежет его внутри рамки по контуру.',
  'selector.samErrorFallback': 'SAM не сработал: {error}\n\nВыполнить это выделение движком «По цвету»?',
  'sam.downloading': 'Загрузка SAM… {loaded} / {total} МБ',
  'sam.preparing': 'Анализ листа…',
  'inspector.fixed': 'ИИ-инспектор: исправлено дефектов — {n}',
  'inspector.lowConfidence': 'ИИ-инспектор: низкая уверенность — проверьте края',
  'sam.working': 'SAM выделяет…',
...
const EN: Record<I18nKey, string> = {
  ...
  'selector.engineLabel': 'Engine:',
  'selector.engine.color': 'By color',
  'selector.engine.sam': 'SAM',
  'selector.hint.smartSam': 'Tap an object — the SAM neural net selects it precisely along its outline. Tap again to deselect.',
  'selector.hint.snapSam': 'Draw a rough box around an object — the SAM neural net cuts it out inside the box along its outline.',
  'selector.samErrorFallback': 'SAM failed: {error}\n\nMake this selection with the "By color" engine instead?',
  'sam.downloading': 'Downloading SAM… {loaded} / {total} MB',
  'sam.preparing': 'Analyzing sheet…',
  'inspector.fixed': 'AI inspector: {n} defect(s) repaired',
  'inspector.lowConfidence': 'AI inspector: low confidence — check the edges',
  'sam.working': 'SAM is selecting…',
